  ...
  return (
    <div className="p-4 md:p-6 space-y-5">
      ...
      <div className="flex items-center justify-between gap-3">
        <div>
          <h1 className="text-xl md:text-2xl font-bold text-foreground">Manajemen User</h1>
          ...
          <table className="w-full text-sm min-w-[480px]">
            <thead>
              <tr className="border-b border-border">
                <th className="px-4 md:px-5 py-3.5 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wider">Email</th>
                <th className="px-4 md:px-5 py-3.5 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wider">Role</th>
                <th className="px-4 md:px-5 py-3.5 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wider hidden sm:table-cell">Status</th>
                <th className="px-4 md:px-5 py-3.5 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wider hidden md:table-cell">Dibuat</th>
              ...
              {!loading && users.map((user) => (
                <>
                  <tr key={user.id} className="border-b border-border last:border-0 hover:bg-accent/30 transition-colors">
                    <td className="px-4 md:px-5 py-4 font-medium text-foreground">
                      <span className="truncate max-w-[140px] sm:max-w-xs block">{user.email}</span>
                    </td>
                    ...
                    <td className="px-4 md:px-5 py-4 text-muted-foreground text-xs hidden md:table-cell">{new Date(user.created_at).toLocaleString("id-ID")}</td>
                    <td className="px-4 md:px-5 py-4">
                  ...
                  {editId === user.id && (
                    <tr key={`edit-${user.id}`} className="bg-accent/20 border-b border-border">
                      <td colSpan={5} className="px-4 md:px-5 py-4">
